...
export default class weatherNow extends React.Component {
  render() {
    return <div className="content"  id="london">

    <img class="mainImage" id="main-MostlyCloudy" src={imgMostlyCloudy} alt="web" />
    <h3 class="t1">overcast clouds</h3>
    <p class="t2"> <strong> Temperature </strong>&nbsp;&nbsp;10° to 11°C</p>
    <p class="t3"> <strong>Humidty</strong> &nbsp;&nbsp; 78% &nbsp;&nbsp; <strong>Pressure&nbsp;&nbsp;</strong> 1008.48  </p>

  </div>
  }
}
export class weather24 extends React.Component {
  render() {
    return (
